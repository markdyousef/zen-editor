...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.handleFileUpload = function (event) {
            ...
            if (addFile) {
                addFile(file).then(function (res) {
                    onChange((0, _utils.insertDataBlock)(editorState, _extends({}, res)));
                    _this.focus();
                }).catch(function (err) {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_draftJsPluginsEditor2.default, {
                            ...
                            onChange: onChange,
                            blockRendererFn: (0, _customRenderer2.default)(editorState, onChange),
                            onTab: this.onTab,
